...
const BotHosting = React.lazy(() => import("./pages/BotHosting"));
const SupportPage = React.lazy(() => import("./pages/Support"));
const MinecraftPage = React.lazy(() => import("./pages/Minecraft"));
const CustomPlansPage = React.lazy(() => import("./pages/CustomPlans"));
    ...
    <div className="min-h-[80vh] flex flex-col items-center justify-center p-4 text-center">
      <div className="space-y-6 max-w-2xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
          ...
          <button
            onClick={() => navigate("/")}
            className="flex items-center justify-center gap-2 px-6 py-3 bg-brand-500 hover:bg-brand-400 text-black rounded-lg transition-colors duration-200"
          >
