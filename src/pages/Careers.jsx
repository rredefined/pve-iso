      ...
      <div className="flex flex-col gap-4">
        <div className="flex justify-between items-start">
          <div className="flex-1">
            ...
            <div className="text-base sm:text-lg font-semibold text-brand-400 mb-3 sm:mb-4">
              {salary}
            </div>
          </div>
          <button
        ...
        >
          ...
          <div className="flex gap-4 pt-4">
            <a
              href={`mailto:hello@renderbyte.site?subject=Application for ${encodeURIComponent(title)}`}
...
const CareersPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Helmet>
        <title>Careers | Renderbyte</title>
      </Helmet>
      <CareersHero />
