...
const LegalTabs = () => {
      ...
      content: [
        {
          ...
          content: "RenderByte offers a 48-hour money-back guarantee for new customers on their first purchase. If you are not satisfied with our services, you may request a full refund within 48 hours of your initial order.",
        },
        {
          title: "2. Eligibility Requirements",
          content: "To be eligible for a refund: The refund request must be made within 48 hours of purchase. This must be your first order with RenderByte. The account must not have violated our Terms of Service. The service must not have been used for abusive purposes. Refunds are limited to one per customer/household.",
        },
        {
          title: "3. Non-Refundable Items",
          content: "The following are NOT eligible for refunds: Domain registrations and Renewals, Special Offer's, Other Payment Methods Than Upi, Add-on services and upgrades after initial purchase, Services suspended or terminated for policy violations, Renewal payments for existing services.",
        },
        {
          title: "4. How to Request a Refund",
          content: "To request a refund: Log in to your account at our Client Area, Open a support ticket in the Billing department, Include your order number and reason for the refund request. Our team will review and respond within 24 hours.",
        },
        {
          title: "5. Refund Processing",
          content: "Approved refunds will be processed within 5-10 business days. Refunds are issued to the original payment method. Please note that your bank or payment provider may take additional time to process the refund to your account.",
        },
        {
          title: "6. Chargebacks",
          content: "We encourage customers to contact us before initiating a chargeback with their payment provider. Chargebacks filed without first contacting our support team may result in account suspension and will be disputed with evidence of service delivery.",
        },
        {
          title: "7. Service Credits",
          content: "In some cases, we may offer service credits instead of monetary refunds for service issues or downtime. Service credits can be applied to future invoices and do not expire.",
        },
        {
          title: "8. Cancellation",
          content: "You may cancel your service at any time through the Client Area. Cancellation requests must be submitted before the renewal date. We do not provide prorated refunds for unused portions of the billing period after the 48-hour money-back guarantee period.",
        },
        {
          title: "9. Contact Us",
          content: "If you have questions about our refund policy or need assistance, please contact our billing team through the Client Area.",
        },
      ],
    },
  };
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Helmet>
        <title>Legal Information | Renderbyte</title>
      </Helmet>
      {/* Header */}
        ...
        <div className="mx-auto">
          ...
          <div className="mt-12 sm:mt-16 p-4 sm:p-6 bg-slate-900 rounded-lg border border-gray-800">
            ...
            <a
              ...
              className="inline-flex items-center text-brand-400 hover:text-brand-600 transition-colors text-sm sm:text-base"
            >
              Contact Legal Team
