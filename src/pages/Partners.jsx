...
const BenefitItem = ({ title, description }) => (
  <div className="flex gap-3 sm:gap-4">
    <CheckCircle2 className="w-5 h-5 sm:w-6 sm:h-6 text-brand-400 shrink-0 mt-1" />
    <div>
...
const PartnersPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Helmet>
        <title>Partner Program | Renderbyte</title>
      </Helmet>
      <PartnersHero />
          ...
          {requirements.map((req, index) => (
            ...
            >
              <div className="w-12 h-12 rounded-lg bg-brand-400/20 flex items-center justify-center mb-4">
                <req.icon className="w-6 h-6 text-brand-400" />
              </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {partners.map((partner, index) => (
            ...
            >
              ...
              <div className="text-sm text-brand-400 mb-2">{partner.type}</div>
