...
const SupportPage = () => {
  const contactMethods = [
    ...
    },
    {
      ...
      available: true,
      href: "https://discord.gg/6nrkKSxt8w",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Helmet>
        <title>Support Center | Renderbyte</title>
      </Helmet>
      {/* Hero Section */}
        ...
        <div className="container max-w-screen-xl mx-auto px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center">
              <div className="text-4xl font-bold text-brand-400 mb-2">1hr</div>
      ...
      <div className="border-t border-slate-800 bg-slate-950">
        <div className="container max-w-screen-xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            ...
            <a
              href="https://status.renderbyte.site"
