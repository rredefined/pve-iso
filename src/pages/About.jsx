  ...
  <div className="border-b border-slate-800">
    <div className="container max-w-screen-xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        <div>
          <span className="text-brand-400 text-sm font-medium mb-2 block">
            About Us
          </span>
    ...
    <div className="container max-w-screen-xl mx-auto px-4 sm:px-6 py-16 sm:py-16">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
        <div className="text-center">
          <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-brand-400 mb-2">
            50K+
          </div>
...
const TimelineItem = ({ year, title, description }) => (
  <div className="relative pl-6 sm:pl-8 pb-8 sm:pb-12 last:pb-0">
    <div className="absolute left-0 top-0 w-3 h-3 sm:w-4 sm:h-4 rounded-full bg-brand-400"></div>
    <div className="absolute left-1.5 sm:left-2 top-4 bottom-0 w-[1px] bg-brand-400/20 last:hidden"></div>
    <div className="text-brand-400 text-sm font-medium mb-2">{year}</div>
...
const AboutPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Helmet>
        <title>About Us | Renderbyte</title>
      </Helmet>
      <AboutHero />
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                <div className="flex items-start gap-3">
                  <Server className="w-5 h-5 text-brand-400 mt-1" />
                  <div>
