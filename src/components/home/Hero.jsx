  ...
  const games = [
    {
      ...
      name: "Minecraft",
      image:
        "https://img.icons8.com/color/512/minecraft-main-character.png",
    },
    {
      id: 2,
      name: "Bot Hosting",
      image:
        "https://img.icons8.com/isometric/512/bot.png",
    },
    {
      id: 3,
      name: "VPS Hosting",
      image:
        "https://img.icons8.com/isometric/512/server.png",
    },
    {
      id: 4,
      name: "Custom Games",
      image:
        "https://img.icons8.com/isometric/512/controller.png",
    },
  ];
  ...
  return (
    <header className="relative min-h-screen flex overflow-hidden">
      <div className="absolute inset-0">
        ...
        <motion.div
          className="absolute inset-0 bg-gradient-to-r from-brand-400/5 to-orange-500/5"
          animate={{
            opacity: [0.5, 0.8, 0.5],
          }}
          transition={{
      ...
      <div className="container max-w-screen-xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            <motion.span
              className="inline-block bg-slate-900 border-slate-800 border px-4 py-2 rounded-xl text-brand-400 text-base sm:text-lg font-medium"
